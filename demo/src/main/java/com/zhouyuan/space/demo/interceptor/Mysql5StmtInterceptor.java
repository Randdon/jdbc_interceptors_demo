...
public class Mysql5StmtInterceptor implements StatementInterceptor {
    private Connection connection;
    private Properties properties;

    private static Logger logger = LoggerFactory.getLogger(Mysql5StmtInterceptor.class);
    ...
    public void init(Connection connection, Properties properties) throws SQLException {
        logger.info("Enter into {}`s init() method.", Mysql5StmtInterceptor.class);
        // Connection
...
/*        if (interceptedStatement instanceof com.mysql.jdbc.PreparedStatement) {
    ...
    public ResultSetInternalMethods postProcess(String sql, Statement interceptedStatement,
        ...
        String level = "info";
        if (null == resultSetInternalMethods){
            code = "1";
            message = "failed";
            level = "error";
        }
